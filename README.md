<img src='https://telegra.ph/file/3c3ab79fba0fa91a4ae8e.jpg' alternate="hina is coming for you ..." height="250px">

# Hina X Assistant [2.0]
...
This repo was just reamped to suit an star community. All original credits go to shinu and his dedication, Without his efforts, this fork would not have been possible!
...
The Support group can be reached out to at [Hina • Support](https://t.me/han_support_groups) Or [Hina Support (Github)](https://github.com/Awesome-Prince/NekoRobot-3/discussions/15), where you can ask for help about [Hina Assistant](https://telegram.me/Shinu_han), discover/request new features, report bugs, and stay in the loop whenever a new update is available. 
...
Start with ```python3 -m Hina_x_Assistant```
